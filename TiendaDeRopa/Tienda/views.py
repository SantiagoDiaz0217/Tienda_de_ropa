...
def booking(request):
    ...
    print(f"Total: {total}, Discounted: {discounted}, Deduction: {deduction}")
...
def payment(request):
    ...
    if request.method == "POST":
        ...
        nombre = request.POST.get('holder_name')
        total = request.POST.get('total')
        discounted = request.POST.get('discounted')
        ...
        Reserva.objects.create(
            ...
            producto=str(cart.product),
            total=discounted,  # Usa el total con descuento aquí
        )
        ...
        message = f'Precio del Pedido: Rs.{total}\nDescuento: Rs.{deduction}\nTotal a Pagar: Rs.{discounted}\nGracias por su compra, {nombre}!'
